...
String place=JOptionPane.showInputDialog("Enter a place");
		...
		String story= "Piranhas are more " + adjective + " during the day, so cross the river at night. Piranhas are attracted to fresh " + liquid + " and will most likely take a bite out of your " + bodypart + " if you are " + verb + ". Whatever you do, if you have an open wound, try to find a better way to get back to the " + place + ". Good luck!";
